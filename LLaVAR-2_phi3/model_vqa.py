...
def eval_model(args):
    ...
    _, _, image_processor, _ = load_pretrained_model(model_path, args.model_base, 'llava-hrv2-phi3-mini-FT-pt5.5-v3.2_shijie_extract_cap_smallv3')
    ...
    for line in tqdm(questions):
        ...
        for k in range(0,len(line["conversations"]),2):
            ...
            gt=line["conversations"][k+1]['value'].replace("\n<image>", "").replace("<image>\n", "")
            cur_prompt = qs
            ############################
