...
deepspeed llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /data/shijie/llava_llama3/checkpoints/llava-v1.5-8b-pretrain/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data/shijie/llava_llama3/checkpoints/llava-v1.5-8b-pretrain-FT \
    --num_train_epochs 1 \
